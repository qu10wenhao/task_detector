...
//
// Based on tasksnoop by Michael Wang
...
const char *argp_program_version = "tasksnoop 0.1";
const char *argp_program_bug_address = "<bpf@vger.kernel.org>";
static const char argp_program_doc[] =
"Trace the related schedule events of a specified task.\n"
"\n"
"USAGE: tasksnoop -t TID [-s] [-d] [-l]\n"
"\n"
"EXAMPLES:\n"
"    tasksnoop -t 49870       	# trace tid 49870\n"
"    tasksnoop -t 49870 -s    	# trace tid 49870 and system call\n"
"    tasksnoop -t 49870 -l	# output schedule events to console\n"
"    tasksnoop -t 49870 -l -d	# output raw timestamp instead of local time\n";
...
static inline void pr_cpu(int map_fd)
{
	int key, prev_key=-1;
	int value;
...
int main(int argc, char **argv)
{
	...
	trace_cpu_maps_fd = bpf_map__fd(obj->maps.trace_cpu_maps);
